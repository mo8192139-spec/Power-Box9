...
export const defaultSiteContent: SiteContent = {
  seo: {
    ...
    metaDescription:
      "Get your 42-count nutritious snack box today! Perfect mix of breakfast bars and savory snacks. High-quality packaging, fast delivery, and satisfaction guaranteed.",
    metaKeywords:
      "snack box, healthy snacks, breakfast bars, gift box, nutritious snacks, office snacks, college care package",
  },
  hero: {
    title:
      "Nutritious Snack Box with Breakfast Bars and Delicious Chips | Gift A Snack (42 Count)",
  ...
  popups: {
    buttonTriggeredPopup: {
      ...
      title: "Special Offer!",
      content:
        "Get 20% off your first order when you sign up for our newsletter. Don't miss out on this limited-time offer!",
    ...
    exitIntentPopup: {
      ...
      content:
        "Subscribe to our newsletter and get exclusive deals on healthy snacks delivered to your inbox!",
      buttonText: "Subscribe Now",
      buttonLink:
        "mailto:newsletter@giftasnack.com?subject=Newsletter Subscription",
      emailLink:
        "mailto:newsletter@giftasnack.com?subject=Newsletter Subscription",
      enabled: true,
    },
