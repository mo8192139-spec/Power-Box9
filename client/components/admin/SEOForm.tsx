...
export function SEOForm() {
  ...
  const [originalContent, setOriginalContent] =
    useState<SEOContent>(seoContent);
  ...
  const hasChanges =
    JSON.stringify(seoContent) !== JSON.stringify(originalContent);
      ...
      >
        <div className="space-y-6">
          ...
          <AdminInput
            ...
            onChange={(value) =>
              updateField("metaDescription", value as string)
            }
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg border">
            ...
            <div className="space-y-2">
              ...
              <div className="text-green-700 text-sm">www.yoursite.com</div>
              <div className="text-gray-600 text-sm leading-relaxed">
                {seoContent.metaDescription ||
                  "Your meta description will appear here as a snippet that describes your page content to search engine users."}
              </div>
            </div>
          </div>
              ...
              <span
                className={`font-medium ${
                  seoContent.metaTitle.length > 60
                    ? "text-red-600"
                    : seoContent.metaTitle.length > 50
                      ? "text-yellow-600"
                      : "text-green-600"
                }`}
              >
              ...
              <span
                className={`font-medium ${
                  seoContent.metaDescription.length > 160
                    ? "text-red-600"
                    : seoContent.metaDescription.length > 150
                      ? "text-yellow-600"
                      : "text-green-600"
                }`}
              >
